/*
 * Swiper 1.0 - Mobile Touch Slider
...
Swiper = function(selector, params, callback) {
	...
	var	wrapper = document.querySelectorAll(selector+' .'+params.wrapperClass).item(0), isHorizontal,
	...
	//Init Function
	_this.init = function() {
		var sliderWidth = document.querySelectorAll(selector).item(0).offsetWidth;
		var sliderHeight = document.querySelectorAll(selector).item(0).offsetHeight;
		sliderSize = isHorizontal ? sliderWidth : sliderHeight;
		numOfSlides = document.querySelectorAll(selector + ' .' + params.slideClass).length
		
		for (var i=0; i<numOfSlides; i++ ) {
			document.querySelectorAll(selector + ' .' + params.slideClass).item(i).style.width=sliderWidth+"px"
			document.querySelectorAll(selector + ' .' + params.slideClass).item(i).style.height=sliderHeight+"px"
		}
	...
	if (params.pagination && params.createPagination) {
		...
		document.querySelectorAll(params.pagination)[0].innerHTML = paginationHTML
	}
	...
	_this.updatePagination = function() {
		var activeSwitch = document.querySelectorAll(params.pagination+' .'+params.paginationActiveClass).item(0)
		...
		document.querySelectorAll(params.pagination+' .'+params.paginationClass).item( _this.activeSlide ).className = document.querySelectorAll(params.pagination+' .'+params.paginationClass).item( _this.activeSlide ).className+' '+params.paginationActiveClass
	}
}
