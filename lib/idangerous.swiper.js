var Swiper = function (selector, params) {
    ...
    _this.init = function (force, forceCalcSlides) {
        ...
        var i, j, slideMaxHeight, wrapperHeight, slideHeight, slideWidth, wrapperWidth, slideLeft;
            ...
            for (i = 0; i < _this.slides.length; i++) {
                ...
                if (params.centeredSlides) {
                    ...
                    if (_slideSize > containerSize) {
                        for (j = 0; j <= Math.floor(_slideSize / (containerSize + _this.wrapperLeft)) ; j++) {
                            if (j === 0) {
                    ...
                    if (_slideSize > containerSize) {
                        for (j = 0; j <= Math.floor(_slideSize / containerSize) ; j++) {
    ...
    _this.resizeFix = function (reInit) {
        ...
        } else if (_this.getWrapperTranslate() < -maxWrapperPosition()) {// move wrapper to the beginning in free mode
    ...
    _this.updatePagination = function (position) {
        ...
        if (params.paginationAsRange) {
            ...
            //Get Visible Indexes
            var visibleIndexes = [];
            for (i = 0; i < _this.visibleSlides.length; i++) {
...
Swiper.prototype = {
    ...
    getWrapperTranslate: function (axis) {
        ...
        if (this.support.transforms && this.params.useCSS3Transforms) {
            ...
            if (window.WebKitCSSMatrix) {
                transformMatrix = new window.WebKitCSSMatrix(curStyle.webkitTransform);
            } else {
    ...
    setWrapperTranslate: function (x, y, z) {
        ...
        if (arguments.length === 3) {
            ...
            coords.y = y;
            coords.z = z;
        } else {// passed one coordinate and optional axis
    ...
    support: {
        ...
        transforms: (window.Modernizr && window.Modernizr.csstransforms === true) || (function () {
            var div = document.createElement('div').style;
            return ('transform' in div || 'WebkitTransform' in div || 'MozTransform' in div || 'msTransform' in div || 'MsTransform' in div || 'OTransform' in div);
        })(),

        transitions: (window.Modernizr && window.Modernizr.csstransitions === true) || (function () {
            var div = document.createElement('div').style;
