...
(function (global, factory) {
  ...
  function updateAutoHeight (speed) {
    ...
    var getActiveSlidesWhenCentered = function () {
      var activeSlides = [];
      ...
      var amountOfSlidesOnEachSide = Math.floor(
    ...
    var getActiveSlides = function () {
      var activeSlides = [];
      for (var i = 0; i < Math.ceil(swiper.params.slidesPerView); i += 1) {
