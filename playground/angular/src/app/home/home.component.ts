...
import { SwiperComponent, SwiperNgEvents } from 'src/angular/src/public-api';
import SwiperCore, {
  Navigation,
  Pagination,
  Scrollbar,
...
export class HomePage {
  ...
  testEvent(event: SwiperNgEvents['beforeTransitionStart']) {
  ...
  onSlideChange(event: SwiperNgEvents['slideChange']) {
    const [swiper] = event;
    if (swiper.isEnd) {
